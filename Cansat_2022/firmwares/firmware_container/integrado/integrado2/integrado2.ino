...
if (SOFTWARE_STATE=="DESCENT" && (altprom<=400.00)){
...
if (SOFTWARE_STATE=="SECOND_PARACHUTE_RELEASE" && (altprom<=350.00)){
...
//}
if (SOFTWARE_STATE=="SECOND_PARACHUTE_RELEASE" && (altprom<=300.00)){
...
if (p1released==true && millis()>Timep6+20000){
  Servo2.write(90);
}
